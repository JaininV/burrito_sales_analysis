...
def addWholeDataApi():
    ...
    vales = (
        ...
        ('pepsi bottle', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('pepsi can', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('diet pepsi bottle', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('diet pepsi can', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('pepsi zero', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito lime', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito mandarian', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito guava', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito mango', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito pineple', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito strawbery', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito fruit punch', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('jarrito maxican cola', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('crush', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('dr.ppr', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('mug of root bear', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('mountain due', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('7up bottel', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('7up can', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('aquafina', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('bubly lime', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('bubly blueberry', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('pure leaf lime', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('pure leaf rasbery', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('chcocolate milk', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('brisk bottle', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('brisk can', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('canada dry bottle', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('red bull', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('red bull suger free', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
        ('canada dry can', random.randint(0,7), 1, random.randint(40,500), formatted_datetime, formatted_datetime),
    )
